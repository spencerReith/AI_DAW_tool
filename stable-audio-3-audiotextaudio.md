Audio-to-Audio
Stable Audio transforms existing audio samples into new high-quality compositions up to six minutes long at 44.1kHz stereo using text instructions. Discover techniques for sample transformation in our Audio to Audio Guide to maximize creative control. Read more about the model capabilities here.
